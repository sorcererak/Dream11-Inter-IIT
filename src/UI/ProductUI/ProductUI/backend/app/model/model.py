...
class Stadium(Base):
    ...
    # Defining columns corresponding to the table structure
    Name = Column(String, nullable=False)
    Location = Column(String, nullable=False)
    Link = Column(String, primary_key=True)
    Pitch_Type = Column("Pitch Type", String)

    def __repr__(self):
        return f"<Stadium(Name={self.Name}, Location={self.Location}, Link={self.Link}, Pitch_Type={self.Pitch_Type})>"
    
class TeamWin(Base):
    __tablename__ = "team_wins"
    id = Column(Integer, primary_key=True)
    team_a = Column(String, nullable=False)
    team_b = Column(String, nullable=False)
    avg_batting_a = Column(Float, nullable=True)
    avg_batting_b = Column(Float, nullable=True)
    avg_wickets_a = Column(Float, nullable=True)
    avg_wickets_b = Column(Float, nullable=True)
    match_date = Column(String, nullable=False)
    match_type = Column(String, nullable=True)
    winner = Column(String, nullable=True)
    winner_a = Column(Integer, nullable=False)
    winner_b = Column(Integer, nullable=False)
    draws = Column(Integer, nullable=False)

    def __repr__(self):
        return f"<TeamWin(team_a={self.team_a}, team_b={self.team_b}, match_date={self.match_date})>"
    

class PlayerLifetimeStats(Base):
    __tablename__ = 'player_lifetime_stats'

    # Define the columns as per the schema
    Unnamed_0 = Column("Unnamed: 0",Integer, primary_key=True)  # Assuming "Unnamed: 0" is the primary key
    player_id = Column(String, nullable=False)
    batting_form_IT20 = Column(Numeric)
    batting_form_MDM = Column(Numeric)
    batting_form_Test = Column(Numeric)
    batting_form_ODM = Column(Numeric)
    batting_form_ODI = Column(Numeric)
    batting_form_T20 = Column(Numeric)
    Adaptability_Score = Column(Numeric)
    batting_consistency_IT20 = Column(Numeric)
    batting_consistency_MDM = Column(Numeric)
    batting_consistency_Test = Column(Numeric)
    batting_consistency_ODM = Column(Numeric)
    batting_consistency_ODI = Column(Numeric)
    batting_consistency_T20 = Column(Numeric)
    bowling_form_IT20 = Column(Numeric)
    bowling_form_MDM = Column(Numeric)
    bowling_form_Test = Column(Numeric)
    bowling_form_ODM = Column(Numeric)
    bowling_form_ODI = Column(Numeric)
    bowling_form_T20 = Column(Numeric)
    Bowling_Adaptability_Score = Column(Numeric)
    bowling_consistency_Test = Column(Numeric)
    bowling_consistency_MDM = Column(Numeric)
    bowling_consistency_ODI = Column(Numeric)
    bowling_consistency_ODM = Column(Numeric)
    bowling_consistency_IT20 = Column(Numeric)
    adaptability_odm = Column(Numeric)
    adaptability_test = Column(Numeric)
    adaptability_t20 = Column(Numeric)
    adaptability_it20 = Column(Numeric)
    adaptability_odi = Column(Numeric)
    adaptability_mdm = Column(Numeric)
    bowling_odi = Column(Numeric)
    bowling_odm = Column(Numeric)
    bowling_test = Column(Numeric)
    bowling_mdm = Column(Numeric)
    bowling_t20 = Column(Numeric)
    bowling_it20 = Column(Numeric)
    fielding_performance_test = Column(Integer)
    fielding_performance_t20 = Column(Integer)
    fielding_performance_odi = Column(Integer)
    fielding_performance_odm = Column(Integer)
    fielding_performance_mdm = Column(Integer)
    all_rounder_performance_TEST = Column(Numeric)
    all_rounder_performance_ODI = Column(Numeric)
    all_rounder_performance_ODM = Column(Numeric)
    all_rounder_performance_MDM = Column(Numeric)
    all_rounder_performance_T20 = Column(Numeric)
